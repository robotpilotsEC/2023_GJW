...
//	Chassis_Top_Speed_Calculating(chassis);
	...
	can2_0x200_send_buff[0] = chassis->base_info.output.motor_LF_current;
	can2_0x200_send_buff[1] = chassis->base_info.output.motor_RF_current;
	can2_0x200_send_buff[2] = chassis->base_info.output.motor_LB_current;
	can2_0x200_send_buff[3] = chassis->base_info.output.motor_RB_current;	
}
